...
//    [PlugField(FieldId = "$$Storage$$", FieldType = typeof(Cosmos.System.FileSystem.Listing.Directory))]
...
//        public static bool get_Exists(DirectoryInfo aThis, [FieldAccess(Name = "$$Storage$$")] ref Cosmos.System.FileSystem.Listing.Directory aStorage)
//        {
...
//        public static string get_Name(DirectoryInfo aThis, [FieldAccess(Name = "$$Storage$$")] ref Cosmos.System.FileSystem.Listing.Directory aStorage)
//        {
//            return aStorage.Name;
//        }

//        public static FileInfo[] GetFiles(DirectoryInfo aThis, [FieldAccess(Name = "$$Storage$$")] ref Cosmos.System.FileSystem.Listing.Directory aStorage)
//        {
//            return null;
...
//            foreach (Cosmos.System.FileSystem.Listing.Base xEntry in xEntries)
//            {
